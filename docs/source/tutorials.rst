...
.. list-table:: 
   ...
   * - **Introduction Tutorial**
     ...
     - `Github <https://github.com/deel-ai/puncc/blob/main/docs/puncc_intro.ipynb>`__ or `colab <https://githubtocolab.com/deel-ai/puncc/blob/main/docs/puncc_intro.ipynb>`__
   * - **API Tutorial**
     - Learn about *puncc*'s API.
     - `Github <https://github.com/deel-ai/puncc/blob/main/docs/api_intro.ipynb>`__ or `colab <https://githubtocolab.com/deel-ai/puncc/blob/main/docs/api_intro.ipynb>`__
   ...
   * - **Architecture Overview**
     - Detailed overview of *puncc*'s architecture.
     - `Github <https://github.com/deel-ai/puncc/blob/main/docs/puncc_architecture.ipynb>`__ or `colab <https://githubtocolab.com/deel-ai/puncc/blob/main/docs/puncc_architecture.ipynb>`__
